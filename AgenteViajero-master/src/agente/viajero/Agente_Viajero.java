...
public class Agente_Viajero extends JFrame implements Runnable{
	...
	JList Caminos;
	Vector cam;
	JButton bt_comenzar,bt_camino,bt_aleatorio;
	JList list;
	JScrollPane pane;
	JComboBox combo;
	...
	Agente_Viajero()
	{
	  ...
	  bt_camino   = new JButton("Generar");
          bt_aleatorio = new  JButton ("Aleatorio");
	  bt_comenzar.addActionListener(new ActionListener()
	  {
         ...
         bt_aleatorio.addActionListener(new ActionListener()
	  {
	  	public void actionPerformed (ActionEvent e)
	  	{
                    for (int i = 0; i < mapa.numAleatorio(); i++) {
                       ...
                       Random ran = new Random();
                        ...
                        point.x = x;
                        point.y = y;
                        mapa.crearEventoDinamico(x, y, point);
                    }
	  	}
	  });
	  list  = new JList();
	  ...
	  bt_camino.setBounds(511,240,100,20);
          bt_aleatorio.setBounds(511,270,100,20);
	  bt_camino.setVisible(false);
	  pane.setBounds(511,35,100,200);
	  tab.setBounds(511,300,800-511,200);
	  c.add(tab);
	  c.add(combo);
	  c.add(bt_comenzar);
	  c.add(bt_camino);

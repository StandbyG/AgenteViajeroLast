	...
	Mapa()
	{
	  ...
	  this.addMouseMotionListener(new MouseMotionAdapter()
	   ...
	   this.addMouseListener(new MouseAdapter()
	   {
        ...
        public void crearEvento(int posX, int posY, Point posPoint) {
            if (!((X==24)||(Y/20==24)))
	   	  	{
	   	  	
	   	  
	   	    puntos[n_puntos++]=posPoint;
	   	    pos.add("("+posX/20+","+Y/20+")");
	   	    x.add(posX/20);y1.add(Y/20);
	   	    repaint();
	   	    if(n_puntos==20)
	   	    {
	   	    	limite=true;
                ...
                System.out.println("NO ENTRO POR LIMITE");
            }
        }
           public void crearEventoDinamico(int posX , int posY, Point posPoint) {
	...
	public void update(Graphics g)
	{
        ...
        public  int numAleatorio()
        {
                                   Random ran = new Random();
                                    ...
                                    int cantidad = ran.nextInt(6) + 5;
                                                System.out.println("Cantidad aleatoirio"  + cantidad);
